...
public class RTTMessagesRepeater implements Runnable {
	...
	//https://wondernetwork.com/pings, average ping from sweden to common places in the world
private final int averageRTT = 117;
	
	public RTTMessagesRepeater(LinkedBlockingQueue<MessageAndAttempts> messageQueue) {
	...
	public void run() {
		while (true) {
			...
			// add message to acknowledgehandler
		}
	}
